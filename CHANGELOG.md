<div align="center">
  <a href="#">
    <img src="https://raw.githubusercontent.com/Daniel-Saprykin/Proxmox/main/misc/images/logo.png" height="100px" />
 </a>
</div>
...
- **Open WebUI LXC** [(Commit)](https://github.com/Daniel-Saprykin/Proxmox/commit/8a21f6e7f025a911865395d4c0fa9a001bd0d512)
...
- **AdventureLog LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/adventurelog-install.sh)
  - NEW Script
...
- **Zoraxy LXC** [(Commit)](https://github.com/Daniel-Saprykin/Proxmox/commit/468a5d367ded4cf453a1507452e112ac3e234e2a)
...
- **Wallos LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/wallos-install.sh)
  - NEW Script
- **Open WebUI LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/openwebui-install.sh)
  - NEW Script
...
- **Cockpit LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/cockpit-install.sh)
  - NEW Script
- **Neo4j LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/neo4j-install.sh)
  - NEW Script
...
- **ArchiveBox LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/archivebox-install.sh)
  - NEW Script
...
- **evcc LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/evcc-install.sh)
  - NEW Script
...
- **MySQL LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/mysql-install.sh)
  - NEW Script
- **Tianji LXC** [(Commit)](https://github.com/Daniel-Saprykin/Proxmox/commit/4c83a790ac9b040da1f11ad2cbe13d3fc5f480e9)
  - Breaking Change
...
- **Home Assistant Core LXC** [(Commit)](https://github.com/Daniel-Saprykin/Proxmox/commit/f2937febe69b2bad8b3a14eb84aa562a8f14cc6a) [(Commit)](https://github.com/Daniel-Saprykin/Proxmox/commit/f2966ced7f457fd506f865f7f5b70ea12c4b0049)
  - Refactor Code
  - Breaking Change
...
- **HomeBox LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/homebox-install.sh)
  - NEW Script
- **Zipline LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/zipline-install.sh)
  - NEW Script
...
- **Tianji LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/tianji-install.sh)
  - NEW Script
...
- **WireGuard LXC** [(Commit)](https://github.com/Daniel-Saprykin/Proxmox/commit/723365a79df7cc0fd29b1af8f7ef200a7e0921b1)
  - Refactor Code
  - Breaking Change
...
- **CommaFeed LXC** [(Commit)](https://github.com/Daniel-Saprykin/Proxmox/commit/0a33d1739ec3a49011411929bd46a260e92e99f9)
  - Refactor Code
  - Breaking Change
...
- **lldap LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/lldap-install.sh)
  - NEW Script
...
- **Gitea LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/gitea-install.sh)
  - NEW Script
...
- **All Scripts** [(Commit)](https://github.com/Daniel-Saprykin/Proxmox/commit/39ea1d4a20b83c07d084ebafdc811eec3548f289)
...
- **Kubo LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/kubo-install.sh)
  - NEW Script
- **RabbitMQ LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/rabbitmq-install.sh)
  - NEW Script
- **Scrutiny LXC**
...
- **MySpeed LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/myspeed-install.sh)
  - NEW Script
...
- **PeaNUT LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/peanut-install.sh)
  - NEW Script
- **Website**
  - If the Changelog has changed recently, the link on the website will pulse.
- **Spoolman LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/spoolman-install.sh)
  - NEW Script
...
- **MeTube LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/metube-install.sh)
  - NEW Script
- **Matterbridge LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/matterbridge-install.sh)
  - NEW Script
- **Website**
...
- **Zabbix LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/zabbix-install.sh)
  - NEW Script
...
- **Petio LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/petio-install.sh)
  - NEW Script
- **Website**
...
- **FlareSolverr LXC** [(View Source)](https://github.com/Daniel-Saprykin/Proxmox/blob/main/install/flaresolverr-install.sh)
  - NEW Script
...
- **Advanced Settings** [(Commit)](https://github.com/Daniel-Saprykin/Proxmox/commit/fc9dff220b4ea426d3a75178ad8accacae4683ca)
...
- **Frigate LXC**
  - Unprivileged Hardware Acceleration https://github.com/Daniel-Saprykin/Proxmox/discussions/2711#discussioncomment-9244629
- **Ubuntu 24.04 VM**
  - NEW Script
...
- **All scripts**
  - As of today, the scripts require the Bash shell specifically. ([more info](https://github.com/Daniel-Saprykin/Proxmox/discussions/2536))
...
- **PairDrop LXC**
  - Removed from the website ([more info](https://github.com/Daniel-Saprykin/Proxmox/discussions/2516))
...
- **Proxmox VE LXC Filesystem Trim**
  - NEW Script ([more info](https://github.com/Daniel-Saprykin/Proxmox/discussions/2505#discussion-6226037))
...
- **Apt-Cacher-NG LXC**
  - NEW Script
- **New Feature**
  - The option to utilize Apt-Cacher-NG (Advanced settings) when creating LXCs. The added functionality is expected to decrease bandwidth usage and expedite package installation and updates. https://github.com/Daniel-Saprykin/Proxmox/discussions/2332
...
- **Sonarr LXC**
  - Breaking Change
  - Complete recode
  - https://github.com/Daniel-Saprykin/Proxmox/discussions/1738#discussioncomment-8005107
...
- **qBittorrent LXC**
  - Removed from this repository for potential malicious hidden code https://github.com/Daniel-Saprykin/Proxmox/discussions/1725
...
- **Proxmox VE Monitor-All**
  - Skip instances based on onboot and templates. [8c2a3cc](https://github.com/Daniel-Saprykin/Proxmox/commit/8c2a3cc4d774fa13d17f695d6bdf9a4deedb1372). 
...
- **[User Submitted Guides](https://github.com/Daniel-Saprykin/Proxmox/blob/main/USER_SUBMITTED_GUIDES.md)**
...
- **v5 Scripts** (Testing before moving forward https://github.com/Daniel-Saprykin/Proxmox/discussions/881)
  - Adguard Home LXC
  - Docker LXC
  - Home Assistant Core LXC
  - PhotoPrism LXC
...
- **Proxmox LXC Updater** 
  - Now updates Ubuntu, Debian, Devuan, Alpine Linux, CentOS-Rocky-Alma, Fedora, ArchLinux [(@Uruknara)](https://github.com/Daniel-Saprykin/Proxmox/commits?author=Uruknara)
...
- **HA Bluetooth Integration Preparation** 
  - [NEW Script](https://github.com/Daniel-Saprykin/Proxmox/discussions/719)
...
- **Container & Core Restore from Backup** 
  - [NEW Scripts](https://github.com/Daniel-Saprykin/Proxmox/discussions/674)
...
- **Home Assistant OS VM** 
  ...
  - 👉 [more info](https://github.com/Daniel-Saprykin/Proxmox/discussions/378)
...
- **ALL LXC's**
  - New [V3 Install Script](https://github.com/Daniel-Saprykin/Proxmox/issues/162) 
- **ioBroker LXC**
  - New Script V3
...
- **Node-Red LXC**
  - Add Install [Themes Script](https://raw.githubusercontent.com/Daniel-Saprykin/Proxmox/main/misc/images/node-red-themes.png)
...
- **Home Assistant Container LXC**
  - Add Options to [Update Menu](https://raw.githubusercontent.com/Daniel-Saprykin/Proxmox/main/misc/images/update-menu.png)
...
- **Home Assistant Container LXC**
  - Add [Update Menu](https://raw.githubusercontent.com/Daniel-Saprykin/Proxmox/main/misc/images/update-menu.png)
...
- **Mariadb LXC**
  - Add [Adminer](https://raw.githubusercontent.com/Daniel-Saprykin/Proxmox/main/misc/images/adminer.png) (formerly phpMinAdmin), a full-featured database management tool
...
- **Jellyfin Media Server LXC**
  - new script to fix [start issue](https://github.com/Daniel-Saprykin/Proxmox/issues/29#issue-1127457380)
- **MotionEye NVR LXC**
  - New script
...
- **misc**
  - new GUI script [(Screenshot)](https://raw.githubusercontent.com/Daniel-Saprykin/Proxmox/main/misc/images/pms-copy-data.png) to copy data from one Plex Media Server LXC to another Plex Media Server LXC 
